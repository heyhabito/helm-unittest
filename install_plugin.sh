...
if [ -n "${HELM_UNITTEST_PLUGIN_NO_INSTALL_HOOK}" ]; then
...
if [ "$(uname)" = "Darwin" ]; then
    url="https://github.com/heyhabito/helm-unittest/releases/download/v${version}/helm-unittest_${version}_darwin_${arch}.tar.gz"
elif [ "$(uname)" = "Linux" ] ; then
    url="https://github.com/heyhabito/helm-unittest/releases/download/v${version}/helm-unittest_${version}_linux_${arch}.tar.gz"
else
...
mv "releases/v${version}/untt" "untt" || \
  mv "releases/v${version}/untt.exe" "untt"
